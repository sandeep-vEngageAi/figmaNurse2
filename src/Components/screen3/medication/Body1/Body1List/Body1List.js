  ...
  return (
    <div className="screen3__body1__list" style={{backgroundColor:props.ElementBGColor}}>
      <div className="screen3__body1__listElement1">
        <p className="screen3__body1__listElement1__name">{props.medicineName} </p>
        <p className="screen3__body1__listElement1__quantity">{props.dosage}</p>
      </div>
      <div className="screen3__body1__listElement2">{props.frequency}</div>
